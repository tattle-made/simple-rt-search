...
def get_feature_hash_from_video (path_to_video):
    ...
    image_proc = multiprocessing.Process(target=extract_and_save_keyframes, args=[path_to_video, no_of_frames, result_folder_path])
    audio_proc = multiprocessing.Process(target=extract_and_save_audio, args=[path_to_video])
...
image_proc = multiprocessing.Process(target=extract_and_save_keyframes, args=["/Users/anushree/tattle/sample_videos/fruitseller.mp4", 15, './results'])
audio_proc = multiprocessing.Process(target=extract_and_save_audio, args=["/Users/anushree/tattle/sample_videos/fruitseller.mp4"])
